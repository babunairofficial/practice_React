...
export default function Card(props) {
  ...
  return (
    ...
    <div>
        ...
        <div
        className="w-64 bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative overflow-hidden m-3"
        >
        ...
        <h1 className="font-bold text-black text-xl">{props.courseName || "UI/UX Creative Designing"}</h1>
